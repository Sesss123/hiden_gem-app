...
exports.register_device_key = functions.https.onCall(async (data, context) => {
    ...
    const deviceId = ((data === null || data === void 0 ? void 0 : data.deviceId) || '').toString().trim();
    const publicKeyPem = ((data === null || data === void 0 ? void 0 : data.publicKeyPem) || '').toString().trim();
    const platform = ((data === null || data === void 0 ? void 0 : data.platform) || 'unknown').toString().trim();
    const model = ((data === null || data === void 0 ? void 0 : data.model) || '').toString().trim();
...
exports.rotate_session_token = functions.https.onCall(async (data, context) => {
    ...
    const uid = context.auth.uid;
    const sessionId = ((data === null || data === void 0 ? void 0 : data.sessionId) || '').toString().trim();
    const presentedTokenHash = ((data === null || data === void 0 ? void 0 : data.presentedTokenHash) || '').toString().trim();
    const deviceId = ((data === null || data === void 0 ? void 0 : data.deviceId) || '').toString().trim();
    ...
    const createdAtMs = ((_a = sessionData.createdAt) === null || _a === void 0 ? void 0 : _a.toMillis) ? sessionData.createdAt.toMillis() : Date.now();
    ...
    const consumedHashes = sessionData.consumedTokenHashes || [];
...
exports.evaluate_security_posture = functions.https.onCall(async (data, context) => {
    if (!context.auth)
        return { riskScore: 100, isBlocked: true, level: 'critical' };
    const uid = context.auth.uid;
    const signals = (data === null || data === void 0 ? void 0 : data.signals) || [];
    const deviceId = ((data === null || data === void 0 ? void 0 : data.deviceId) || '').toString();
    let riskScore = 0;
    const activeThreats = [];
...
exports.issue_step_up_grant = functions.https.onCall(async (data, context) => {
    ...
    if (!context.auth)
        throw new functions.https.HttpsError('unauthenticated', 'Login required.');
    const uid = context.auth.uid;
    const action = ((data === null || data === void 0 ? void 0 : data.action) || '').toString().trim();
    const deviceId = ((data === null || data === void 0 ? void 0 : data.deviceId) || '').toString().trim();
    ...
    const postureDoc = await admin.firestore()
        ...
        .doc('posture')
        .get();
    if (postureDoc.exists && ((_a = postureDoc.data()) === null || _a === void 0 ? void 0 : _a.isBlocked) === true) {
