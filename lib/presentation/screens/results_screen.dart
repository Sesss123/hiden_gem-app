...
class _ResultsScreenState extends ConsumerState<ResultsScreen>
  ...
  Widget _buildDayHeader(BuildContext context, ItineraryDay day) {
        ...
        children: [
          Container(
            ...
            child: Center(
              child: Text(
                "${day.day}", 
                style: GoogleFonts.outfit(color: Theme.of(context).scaffoldBackgroundColor, fontWeight: FontWeight.bold, fontSize: 20),
              ),
            ),
          ),
          SizedBox(width: 20),
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  "CHRONICLE DAY ${day.day}".toUpperCase(), 
                  style: GoogleFonts.inter(
                    color: Theme.of(context).colorScheme.primary, 
                ...
                if (day.sinhalaPhrase != null) ...[
                  SizedBox(height: 10),
                  _buildSinhalaSegment(context, day.sinhalaPhrase!),
                ],
              ],
            ),
          ),
  ...
  Widget _buildSinhalaSegment(BuildContext context, String phrase) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            "Local Aura: \"$phrase\"",
            style: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.7)),
          ),
        ],
      ),
    );
  ...
  Widget _buildTimelineItem(BuildContext context, ItineraryItem item) {
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Theme.of(context).colorScheme.primary.withValues(alpha: 0.4), Colors.transparent],
                      begin: Alignment.topCenter,
                      end: Alignment.bottomCenter,
                    ),
                  )
            ...
            child: OracleUI.glassContainer(
              ...
              child: Column(
                ...
                children: [
                    ...
                    Row(
                      children: [
                        _infoChip(context, "${item.durationMin} MINS", Colors.grey.shade600),
                        if (item.costLkr > 0) ...[
                          SizedBox(width: 12),
                          _infoChip(context, _fmtLkr(item.costLkr), AppTheme.modernGreen(context)),
                        ],
                      ],
                    ),
                    if (item.notes.isNotEmpty) ...[
                      ...
                      Text(
                        ...
                        style: GoogleFonts.inter(
                          fontSize: 13, 
                          color: AppTheme.darkText(context).withValues(alpha: 0.7), 
                          height: 1.5,
                        ),
                      ),
                    ],
                    _buildItemExcellenceBadges(context, item),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildItemExcellenceBadges(BuildContext context, ItineraryItem item) {
    if (item.ecoTip == null && item.etiquette == null && (item.transportCostLkr == null || item.transportCostLkr == 0)) {
    ...
    return Column(
      children: [
        ...
        Wrap(
          ...
          children: [
            if (item.ecoTip != null)
              _excellenceChip(context, Icons.eco_outlined, "Eco: ${item.ecoTip}", Colors.teal),
            if (item.etiquette != null)
              _excellenceChip(context, Icons.temple_buddhist_outlined, "Etiquette: ${item.etiquette}", Theme.of(context).colorScheme.secondary),
            if (item.transportCostLkr != null && item.transportCostLkr! > 0)
              _excellenceChip(context, Icons.local_taxi_outlined, "Transport: ~LKR ${item.transportCostLkr}", AppTheme.modernBlue(context)),
          ],
        ),
      ],
    );
  ...
  Widget _excellenceChip(BuildContext context, IconData icon, String label, Color color) {
    return Container(
  ...
  _TypeInfo _typeInfo(BuildContext context, String type) {
    switch (type) {
      case 'transport':
      ...
      case 'attraction':
        return _TypeInfo(Icons.star, AppTheme.primaryBlue(context), "Attraction");
      default:
