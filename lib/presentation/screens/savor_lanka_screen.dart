...
class _SavorLankaScreenState extends ConsumerState<SavorLankaScreen>
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(AppLocalizations.of(context)!
                .oracleLostFocusMessage(e.toString())),
  ...
  Widget _buildResultCard() {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: OracleUI.glassContainer(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              _buildNutritionReliability(
                  res.nutritionReliability, res.reliabilityReason),
              SizedBox(height: 24),
              _buildNeuralReasoningCard(
                  res.detectionBasis, res.confidenceLabel),
              SizedBox(height: 24),
              ...
              SizedBox(height: 24),
              _buildAuthenticityScore(res.authenticityScore.toDouble(),
                  res.culinaryStyle, res.variationNote),
              SizedBox(height: 32),
        ...
        .scaleY(begin: 0.9, curve: Curves.easeOutBack);
  }
        ...
        if (influences.isNotEmpty) ...[
          ...
          Text(
            AppLocalizations.of(context)!
                .influencesLabel(influences.join(', ')),
            style: GoogleFonts.inter(
  ...
  Widget _buildNutritionReliability(String reliability, String reason) {
    final Color color = reliability == 'High'
        ? AppTheme.colors.greenAccent
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                    AppLocalizations.of(context)!
                        .nutritionReliabilityLabel(reliability),
                    style: GoogleFonts.outfit(
                        color: color,
                        fontSize: 9,
                        fontWeight: FontWeight.w900)),
                if (reason.isNotEmpty)
                  Text(reason,
                      style: GoogleFonts.inter(
                          color: AppTheme.colors.white38, fontSize: 8)),
              ],
            ),
          ),
        ],
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 10),
              OracleUI.neonText(
                  AppLocalizations.of(context)!.neuralReasoningLabel,
                  style: GoogleFonts.outfit(
                      color: Theme.of(context).colorScheme.primary,
                      fontSize: 11,
                      fontWeight: FontWeight.w900,
          ...
          Text(
            basis.isEmpty
                ? AppLocalizations.of(context)!.aiVisualMarkersFallback(label)
                : basis,
            style: GoogleFonts.inter(
                color: AppTheme.colors.white70, fontSize: 13, height: 1.5),
          ),
        ],
      ),
    );
  ...
  Widget _buildAuthenticityScore(double score, String style, String note) {
    return Column(
      ...
      children: [
        _buildSectionTitle(
            AppLocalizations.of(context)!.authenticityIntelligenceTitle),
        SizedBox(height: 16),
        Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: AppTheme.accentOchre(context).withValues(alpha: 0.3),
                    width: 2),
              ),
              child: Center(
  ...
  Widget _buildIngredientInference(FoodModel res,
      {required Function(List<String>) onEdit}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          ...
          children: [
            _buildSectionTitle(
                AppLocalizations.of(context)!.ingredientCertaintyTitle),
            IconButton(
              onPressed: () =>
                  _showEditIngredientsDialog(res.confirmedIngredients, onEdit),
        ...
        SizedBox(height: 16),
        _ingredientTier(AppLocalizations.of(context)!.ingredientTierConfirmed,
            res.confirmedIngredients, AppTheme.colors.greenAccent),
        SizedBox(height: 12),
        _ingredientTier(AppLocalizations.of(context)!.ingredientTierLikely,
            res.likelyIngredients, AppTheme.colors.orangeAccent),
        if (res.optionalIngredients.isNotEmpty) ...[
          SizedBox(height: 12),
          _ingredientTier(AppLocalizations.of(context)!.ingredientTierOptional,
              res.optionalIngredients, AppTheme.colors.blueAccent),
        ],
      ],
    );
  }
  ...
  void _showEditIngredientsDialog(
      List<String> current, Function(List<String>) onSave) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text(AppLocalizations.of(context)!.manualCulinaryOverrideTitle,
            style: GoogleFonts.outfit(
                color: AppTheme.colors.white,
                fontWeight: FontWeight.w900,
                fontSize: 16,
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
                borderSide: BorderSide(color: AppTheme.colors.white12),
        ...
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(context),
              child: Text(
                  AppLocalizations.of(context)!.cancelButtonUppercaseAlt,
                  style: GoogleFonts.inter(
                      color: AppTheme.colors.white38,
          ...
          ElevatedButton(
            ...
            child: Text(AppLocalizations.of(context)!.applyOverrideButton,
        ...
        Wrap(
          ...
          children: items
              .map((item) => Container(
                    ...
                    child: Text(item,
                        style: GoogleFonts.inter(
                            color: AppTheme.colors.white70, fontSize: 11)),
                  ))
              .toList(),
        ),
      ],
  ...
  Widget _buildMealContext(String mealContext, List<String> supporting) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: AppTheme.colors.white.withValues(alpha: 0.05)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Icon(Icons.layers_rounded,
                  color: AppTheme.colors.blueAccent, size: 18),
              SizedBox(width: 10),
              Text(AppLocalizations.of(context)!.mealContextLabel(mealContext),
                  style: GoogleFonts.outfit(
          ...
          if (supporting.isNotEmpty) ...[
            SizedBox(height: 12),
            Text(AppLocalizations.of(context)!.supportingElementsLabel,
                style: GoogleFonts.inter(
                    color: AppTheme.colors.white38,
                    fontSize: 9,
                    fontWeight: FontWeight.w900)),
            SizedBox(height: 8),
            Text(supporting.join(" • "),
                style: GoogleFonts.inter(
                    color: AppTheme.colors.white70, fontSize: 12)),
          ],
        ],
      ),
    );
  ...
  Widget _buildFreshnessQualityLayer(FoodModel res) {
    final Color color = res.freshnessIndex > 80
        ? AppTheme.colors.greenAccent
        : (res.freshnessIndex > 50
            ? AppTheme.colors.orangeAccent
            : AppTheme.colors.redAccent);
    return Container(
      padding: EdgeInsets.all(20),
        ...
        children: [
            ...
            children: [
              Row(
                children: [
                  ...
                  SizedBox(width: 12),
                  Text(
                      AppLocalizations.of(context)!.visualFreshnessQualityLabel,
                      style: GoogleFonts.outfit(
                          color: color,
                          fontSize: 11,
                          fontWeight: FontWeight.w900,
          ...
          Row(
            children: [
              _buildQualityChip(
                  AppLocalizations.of(context)!
                      .qualityColonLabel(res.visualQuality),
                  color),
              SizedBox(width: 8),
              _buildQualityChip(
                  AppLocalizations.of(context)!
                      .textureColonLabel(res.visualTextureStatus),
                  color),
            ],
          ),
          SizedBox(height: 16),
      ...
      children: [
        Row(
          children: [
            Icon(Icons.history_edu_rounded,
                color: AppTheme.accentOchre(context), size: 20),
            SizedBox(width: 12),
            OracleUI.neonText(
                AppLocalizations.of(context)!.heritageNarrativeEngineTitle,
                style: GoogleFonts.outfit(
                    color: AppTheme.accentOchre(context),
                    fontSize: 12,
                    fontWeight: FontWeight.w900,
        ...
        if (res.verifiedHeritage.isNotEmpty)
          _buildHeritageSection(
              AppLocalizations.of(context)!.verifiedLegacyTitle,
              res.verifiedHeritage,
              Icons.verified_user_rounded,
              AppTheme.colors.blueAccent),
        if (res.regionalTradition.isNotEmpty)
          _buildHeritageSection(
              AppLocalizations.of(context)!.regionalTraditionTitle,
              res.regionalTradition,
              Icons.place_rounded,
              AppTheme.colors.greenAccent),
        if (res.folkloreNarrative.isNotEmpty)
          _buildHeritageSection(
              AppLocalizations.of(context)!.folkloreNarrativeTitle,
              res.folkloreNarrative,
  ...
  Widget _buildCulinaryGapPairingEngine(FoodModel res) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: AppTheme.colors.cyanAccent.withValues(alpha: 0.1)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Icon(Icons.extension_rounded,
                  color: AppTheme.colors.cyanAccent, size: 20),
              SizedBox(width: 12),
              OracleUI.neonText(
                  AppLocalizations.of(context)!.culinaryGapPairingEngineTitle,
                  style: GoogleFonts.outfit(
          ...
          SizedBox(height: 20),
          Text(AppLocalizations.of(context)!.missingCompanionsLabel,
              style: GoogleFonts.inter(
                  color: AppTheme.colors.white38,
                  fontSize: 9,
                  fontWeight: FontWeight.w900)),
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: res.missingCompanions
                .map((e) => Container(
                      padding:
                          EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                      decoration: BoxDecoration(
                          color:
                              AppTheme.colors.redAccent.withValues(alpha: 0.1),
                          borderRadius: BorderRadius.circular(10)),
                      child: Text(e,
                          style: GoogleFonts.inter(
          ...
          if (res.pairingNotes.isNotEmpty) ...[
            SizedBox(height: 20),
            Text(AppLocalizations.of(context)!.engineNotesLabel,
                style: GoogleFonts.inter(
                    color: AppTheme.colors.white38,
                    fontSize: 9,
                    fontWeight: FontWeight.w900)),
            SizedBox(height: 8),
            Text(res.pairingNotes,
                style: GoogleFonts.inter(
                    color: AppTheme.colors.white.withValues(alpha: 0.9),
                    fontSize: 13,
                    height: 1.5)),
  ...
  Widget _buildRecipeRefactorEngine(FoodModel res) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppTheme.colors.orangeAccent.withValues(alpha: 0.1),
            AppTheme.colors.transparent
          ],
        ...
        borderRadius: BorderRadius.circular(30),
        border: Border.all(
            color: AppTheme.colors.orangeAccent.withValues(alpha: 0.2)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Icon(Icons.settings_suggest_rounded,
                  color: AppTheme.colors.orangeAccent, size: 22),
              SizedBox(width: 12),
              OracleUI.neonText(
                  AppLocalizations.of(context)!.recipeRefactorEngineTitle,
                  style: GoogleFonts.outfit(
            ...
            child: Row(
              children: [
                Icon(Icons.person_outline_rounded,
                    color: AppTheme.colors.white38, size: 16),
                SizedBox(width: 10),
                Expanded(
                  child: Text(
          ...
          if (res.personalizedSteps.isNotEmpty) ...[
            SizedBox(height: 20),
            Text(AppLocalizations.of(context)!.refactoredStepsForYouLabel,
                style: GoogleFonts.inter(
                    color: AppTheme.colors.white38,
                    fontSize: 9,
                    fontWeight: FontWeight.w900)),
  ...
  Widget _buildMetricsDashboard(FoodModel res) {
    ...
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        _metricTile(Icons.schedule_rounded, "${res.prepTimeMinutes}m",
            l10n.prepMetricLabel),
        _metricTile(Icons.restaurant_menu_rounded, "${res.cookTimeMinutes}m",
            l10n.cookMetricLabel),
        _metricTile(
            Icons.bolt_rounded, res.difficultyLevel, l10n.levelMetricLabel),
        _metricTile(Icons.local_fire_department_rounded,
            "${res.estimatedCalories}", l10n.calMetricLabel),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(AppLocalizations.of(context)!.healthRatingLabel,
                style: GoogleFonts.outfit(
                    color: AppTheme.colors.white38,
                    fontSize: 10,
                    fontWeight: FontWeight.w900,
                    letterSpacing: 1)),
            Text(AppLocalizations.of(context)!.healthRatingValueLabel(rating),
                style: GoogleFonts.outfit(
                    color: Theme.of(context).colorScheme.primary,
                    fontSize: 14,
                    fontWeight: FontWeight.w900)),
            ...
            children: steps.asMap().entries.map((entry) {
              ...
              return Padding(
                ...
                child: AnimatedContainer(
                  ...
                  .animate()
                  .fadeIn(delay: (idx * 100).ms, duration: 400.ms)
                  .slideX(begin: 0.1);
            }).toList(),
          );
        });
  ...
  Widget _buildOracleInsights(List<String> tips) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        OracleUI.neonText(AppLocalizations.of(context)!.oracleInsightsTitle,
            style: GoogleFonts.outfit(
                color: AppTheme.accentOchre(context),
                fontSize: 11,
                fontWeight: FontWeight.w900,
        ...
        ...tips.map((tip) => Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color:
                        AppTheme.accentOchre(context).withValues(alpha: 0.1)),
              ),
              child: Row(
                children: [
                  Icon(Icons.auto_awesome,
                      color: AppTheme.accentOchre(context), size: 16),
                  SizedBox(width: 16),
                  Expanded(
                      child: Text(tip,
                          style: GoogleFonts.inter(
  ...
  Widget _buildSubstitutionsCarousel(List<String> subs) {
    return Column(
      ...
      children: [
        _buildSectionTitle(
            AppLocalizations.of(context)!.globalSubstitutionsTitle),
        SizedBox(height: 16),
        SizedBox(
          height: 60,
            ...
            itemBuilder: (context, idx) {
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      AppTheme.colors.tealAccent.withValues(alpha: 0.05),
                      AppTheme.colors.tealAccent.withValues(alpha: 0.1)
                    ],
                  ),
                  border: Border.all(
                      color: AppTheme.colors.tealAccent.withValues(alpha: 0.1)),
                ),
                child: Center(
                  child: Text(subs[idx],
                      style: GoogleFonts.outfit(
        ...
        builder: (context, _) {
          ...
          return Container(
            ...
            child: Row(
              ...
              .animate()
              .slideY(begin: 1.0, duration: 800.ms, curve: Curves.easeOutQuart);
        });
  }
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _isSaved
              ? Theme.of(context).colorScheme.primary
              : AppTheme.colors.white.withValues(alpha: 0.1),
          shape: BoxShape.circle,
        ),
        child: Icon(
            ...
            child: _isAnalyzing
                ? Center(
                    child: CircularProgressIndicator(
                        color: AppTheme.colors.black, strokeWidth: 3))
                : Icon(Icons.restaurant_rounded,
                    color: AppTheme.colors.black, size: 36),
          ),
        ),
      ),
    );
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(25),
            border: Border.all(
                color: AppTheme.colors.deepPurpleAccent.withValues(alpha: 0.1)),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(
                ...
                style: GoogleFonts.inter(
                    color: AppTheme.colors.deepPurpleAccent,
                    fontSize: 10,
                    fontWeight: FontWeight.w900,
                    letterSpacing: 1),
              ),
  ...
  Widget _buildHygieneIntegrityLayer(FoodModel res) {
    final Color color = res.hygieneScore > 90
        ? AppTheme.colors.cyanAccent
        : (res.hygieneScore > 70
            ? AppTheme.colors.orangeAccent
            : AppTheme.colors.redAccent);
        ...
        children: [
          Row(
            children: [
              ...
              Text(AppLocalizations.of(context)!.phase6HygienePresentationTitle,
                  style: GoogleFonts.outfit(
                      color: color,
                      fontSize: 11,
                      fontWeight: FontWeight.w900,
          ...
          if (res.presentationAnalysis.isNotEmpty)
            Text(
              ...
              style: GoogleFonts.inter(
                  color: AppTheme.colors.white70, fontSize: 12, height: 1.5),
            ),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(
                child: _buildPresentationMiniMetric(
                    AppLocalizations.of(context)!.presentationLabel,
                    res.presentationScore,
                    AppTheme.colors.blueAccent),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: _buildPresentationMiniMetric(
                    AppLocalizations.of(context)!.integrityLabel,
                    res.hygieneScore,
                    AppTheme.colors.greenAccent),
              ),
            ],
        ...
        _buildAssistantAction(
          ...
          onTap: () {
            SharePlus.instance.share(
              ShareParams(
                text: l10n.savorLankaShareText(
                    res.name, res.hygieneScore.toString()),
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(
            vertical: 16, horizontal: label.isEmpty ? 16 : 0),
        decoration: BoxDecoration(
          color: color.withValues(alpha: 0.1),
          borderRadius: BorderRadius.circular(20),
        ...
        child: Row(
          ...
          children: [
            Icon(icon,
                color: color == AppTheme.colors.white24
                    ? AppTheme.colors.white
                    : color,
                size: 20),
            if (label.isNotEmpty) ...[
...
class _SavorScannerOverlayState extends State<_SavorScannerOverlay>
