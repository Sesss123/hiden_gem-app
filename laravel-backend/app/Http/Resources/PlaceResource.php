...
class PlaceResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'temporarilyClosed' => (bool) $this->temporarily_closed,
            'closure_note' => $this->closure_note ?? '',
            'closureNote' => $this->closure_note ?? '',
            'closure_until' => optional($this->closure_until)->toIso8601String(),
            'closureUntil' => optional($this->closure_until)->toIso8601String(),
            'holiday_hours_note' => $this->holiday_hours_note ?? '',
            'holidayHoursNote' => $this->holiday_hours_note ?? '',
