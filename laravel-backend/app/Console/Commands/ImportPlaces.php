        ...
        foreach ($files as $path) {
            ...
            foreach ($data as $item) {
                ...
                Place::create([
                    ...
                    'ticket_range' => $item['ticketRange'] ?? $item['ticket_price'] ?? 'Free',
                    'ticket_price' => $item['ticket_price'] ?? $item['ticketRange'] ?? 'Free',
                    'road_type' => $item['roadType'] ?? $item['road_condition'] ?? 'Unknown',
                    ...
                    'best_time' => $item['bestTime'] ?? $item['best_time_to_visit'] ?? 'Anytime',
